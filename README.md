...
I am seeking **software engineering opportunities that maximize my impact**, where I can design and optimize scalable solutions. My areas of interest include:

* **Business Applications Developer** – Building enterprise applications and automation using Zoho Creator, Deluge, and REST APIs.
* **Backend Engineer** – Building secure APIs, microservices, and high-performance backend services.
* **DevOps / Cloud Engineer** – Designing CI/CD pipelines, containerization (Docker/K8s), and cloud automation (AWS/Azure).
* **Software Engineer** – Developing reliable, production-ready software using clean architecture.
* **Integration Engineer** – Connecting complex business systems through APIs and data synchronization.
...
* Built a **Garage Management System** using **Zoho Creator**, automating vehicle service, inventory, and workshop operations.
* Integrated **Money & Wallet APIs** to build fintech solutions enabling secure digital transactions and fund transfers.
* Designed and implemented **enterprise business applications** that automated manual workflows, reducing operational delays by 50%.
* Delivered custom software solutions across **fintech, payroll, and business operations** for diverse digital transformations.
...
**Tech Stack:** Docker, Kubernetes, Terraform, AWS  
<p>
...
Web-Based Queue Management Application for real-time customer position tracking.  
...
* Expertise in **Zoho Creator, Deluge, REST APIs, and enterprise integrations**.
* Experienced in **backend development**, API design, and scalable business solutions.
* Proven ability across **payroll, fintech, garage management, and HR** domains.
